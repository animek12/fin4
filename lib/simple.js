const { 
 ...
       return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : this.sendMessage(jid, text, MessageType.extendedText, { contextInfo: { mentionedJid: this.parseMention(text), forwardingScore: 999, isForwarded: true, externalAdReply: {title: '💌 HAORI - YANZZ', body: 'Stay Grateful With Your Life :3', sourceUrl: '', thumbnail: fs.readFileSync('./thumbnail.jpg')}}, sendEphemeral: true, quoted, ...options })
   }
